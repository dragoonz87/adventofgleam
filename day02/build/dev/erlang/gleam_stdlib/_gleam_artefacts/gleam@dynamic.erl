...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 31).
-spec from(any()) -> dynamic_().
from(A) ->
    gleam_stdlib:identity(A).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 39).
-spec dynamic(dynamic_()) -> {ok, dynamic_()} | {error, list(decode_error())}.
dynamic(Value) ->
    {ok, Value}.

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 60).
-spec bit_array(dynamic_()) -> {ok, bitstring()} | {error, list(decode_error())}.
bit_array(Data) ->
    gleam_stdlib:decode_bit_array(Data).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 107).
-spec put_expected(decode_error(), binary()) -> decode_error().
put_expected(Error, Expected) ->
    erlang:setelement(2, Error, Expected).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 120).
-spec classify(dynamic_()) -> binary().
classify(Data) ->
    gleam_stdlib:classify_dynamic(Data).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 137).
-spec int(dynamic_()) -> {ok, integer()} | {error, list(decode_error())}.
int(Data) ->
    gleam_stdlib:decode_int(Data).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 160).
-spec float(dynamic_()) -> {ok, float()} | {error, list(decode_error())}.
float(Data) ->
    gleam_stdlib:decode_float(Data).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 183).
-spec bool(dynamic_()) -> {ok, boolean()} | {error, list(decode_error())}.
bool(Data) ->
    gleam_stdlib:decode_bool(Data).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 209).
-spec shallow_list(dynamic_()) -> {ok, list(dynamic_())} |
    {error, list(decode_error())}.
shallow_list(Value) ->
    gleam_stdlib:decode_list(Value).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 352).
-spec optional(fun((dynamic_()) -> {ok, CHW} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(CHW)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 487).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1017).
-spec any(list(fun((dynamic_()) -> {ok, CLW} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        CLW} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1513).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1050).
-spec decode1(
    fun((CMA) -> CMB),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 559).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 240).
-spec result(
    fun((dynamic_()) -> {ok, CHE} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CHG} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, CHE} | {error, CHG}} |
    {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 297).
-spec list(fun((dynamic_()) -> {ok, CHR} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(CHR)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 87).
-spec map_errors(
    {ok, CGF} | {error, list(decode_error())},
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 95).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 83).
-spec string(dynamic_()) -> {ok, binary()} | {error, list(decode_error())}.
string(Data) ->
    decode_string(Data).

-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 381).
-spec field(
    any(),
    fun((dynamic_()) -> {ok, CIG} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, CIG} | {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 423).
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, CIK} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(CIK)} |
    {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 466).
-spec element(
    integer(),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 549).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 625).
-spec tuple2(
    fun((dynamic_()) -> {ok, CJS} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CJU} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {CJS, CJU}} | {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 694).
-spec tuple3(
...
) -> fun((dynamic_()) -> {ok, {CJX, CJZ, CKB}} | {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 765).
-spec tuple4(
...
) -> fun((dynamic_()) -> {ok, {CKE, CKG, CKI, CKK}} |
    {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 838).
-spec tuple5(
...
) -> fun((dynamic_()) -> {ok, {CKN, CKP, CKR, CKT, CKV}} |
    {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 913).
-spec tuple6(
...
) -> fun((dynamic_()) -> {ok, {CKY, CLA, CLC, CLE, CLG, CLI}} |
    {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 964).
-spec dict(
    fun((dynamic_()) -> {ok, CLL} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLN} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(CLL, CLN)} |
    {error, list(decode_error())}).
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1078).
-spec decode2(
    fun((CME, CMF) -> CMG),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1110).
-spec decode3(
    fun((CMK, CML, CMM) -> CMN),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1156).
-spec decode4(
    fun((CMS, CMT, CMU, CMV) -> CMW),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1212).
-spec decode5(
    fun((CNC, CND, CNE, CNF, CNG) -> CNH),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1272).
-spec decode6(
    fun((CNO, CNP, CNQ, CNR, CNS, CNT) -> CNU),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1337).
-spec decode7(
    fun((COC, COD, COE, COF, COG, COH, COI) -> COJ),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1406).
-spec decode8(
    fun((COS, COT, COU, COV, COW, COX, COY, COZ) -> CPA),
...
-file("/home/drag/Documents/AdventOfCode/2024/Gleam/day02/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1479).
-spec decode9(
    fun((CPK, CPL, CPM, CPN, CPO, CPP, CPQ, CPR, CPS) -> CPT),
